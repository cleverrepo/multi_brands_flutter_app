...
class Rebok extends StatefulWidget {
  const Rebok({
    super.key,
  });

  @override
  State<Rebok> createState() => _RebokState();
}

class _RebokState extends State<Rebok> {
          ...
          Expanded(
            child: SizedBox(
              ...
              child: GridView.builder(
                  itemCount: DataModel.rebok.length,
                    ...
                    return Padding(
                      ...
                      child: InkWell(
                        onTap: () {
                          Get.to(
                                  () => Details(
                                datamodel: DataModel.rebok[index],
                              ),
                          ...
                          child: Stack(
                            children: [
                              ...
                              Positioned(
                                ...
                                left: 80,
                                child: Text(
                                  DataModel.rebok[index].productName,
                                  style: TextStyle(
                                    color: themeprovider.darktheme
                                        ? Colors.white
                                        : Colors.black,
                              ...
                              Positioned(
                                  ...
                                  left: 10,
                                  child: Text(
                                      "\$${DataModel.rebok[index].productPrice}",
                                      style: TextStyle(
                                        fontSize: fontsize,
